...
// 3.0以上使用@WebServlet注解，web.xml不再是必须；"/FatieUpdateServlet": url路径
@WebServlet("/FatieUpdateServlet")
public class FatieUpdateServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		/*pa = pa.substring(0, pa.indexOf("\\.")).replace("\\", "/");*/   //获取的项目目录超出长度
		String th = request.getContextPath();

		System.out.println(pa + th);
		///WebContent/upload_Fatie
		String uploadPath = (pa + th) + "..\\img\\upload_Fatie";
