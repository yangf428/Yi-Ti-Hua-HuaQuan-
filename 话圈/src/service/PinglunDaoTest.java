...
/*		PinglunDao pinglunDao=new PinglunDaoImpl();
			...
			String sql = "insert into pinglun (userid,byid,pcontent) values(?,?,?)";
			//sql = sql + "values(?,?,?)";*/
			stat = conn.prepareStatement(sql);

			stat.setInt(1, pinglun.getUserid());
			stat.setInt(2, pinglun.getByid());
			stat.setString(3, pinglun.getPcontent());
