...
<head>
    ...
    <script type="text/javascript">
        function reloadCode(){
            ...
            verify.setAttribute("src","../f/makeCertPic.jsp?it="+Math.random());
        }
        function reloadCode2(){
            var verify2 = document.getElementById("code-img-r");
            verify2.setAttribute("src","../f/makeCertPic.jsp?it="+Math.random());
        }
    </script>
    <!---------------------------- 验证码-end ------------------------------>
</head>
...
<div class="popup" id="popup-r">
    ...
    <div class="min">
        <div class="tc_login">
            <div class="right">
                <form action="LoginServlet" method="get" name="form_login">
                    <div>
                        ...
                        <dd><img src="../f/makeCertPic.jsp" id="code-img" onclick="reloadCode()" alt="看不清楚，换一张"/></dd>
                    </div>
                    <div align="center">
            ...
            <dd>
                <div align="center"><a href="../f/blogList.jsp#" class="rc">立即注册</a></div>
            </dd>
        </div>
    </div>
</div>
...
<div class="popup-r" id="popup">
    ...
    <div class="min">
        <div class="tc_login">
            <div class="right">
                <form action="LoginServlet" method="get" name="form_login">
                    <div>
                        ...
                        <dd><img src="../f/makeCertPic.jsp" id="code-img-r" onclick="reloadCode2()" alt="看不清楚，换一张"/></dd>
                    </div>
                    <div align="center">
            ...
            <dd>
                <div align="center" class="register"><a href="../f/blogList.jsp#" id="register" class="tc">登录</a></div>
            </dd>
        </div>
    </div>
</div>
